...
namespace Eventures.AndroidApp.AppiumTests
{
    public class AppiumTests : AppiumTestsBase
    {
        ...
        {
            var loginBtn = driver.FindElementById("buttonLogin");
            Assert.That(loginBtn.Enabled == false);
            var registerBtn = driver.FindElementById("buttonRegister");
            Assert.That(registerBtn.Enabled == false);

            var connectBtn = driver.FindElementById("buttonConnect");
            connectBtn.Click();
            ...
            var statusBox = driver.FindElementById("textViewStatus");
            while (statusBox.Text == "Connecting ...")
            {
                statusBox = driver.FindElementById("textViewStatus");
            }
        ...
        {
            var addBtn = driver.FindElementById("buttonAdd");
            Assert.That(addBtn.Enabled == false);

            var reloadBtn = driver.FindElementById("buttonReload");
        ...
        public void Test_CreateEvent_WithValidData()
        {
            ...
            var okButton = driver.FindElementByXPath("//android.widget.ScrollView/android.widget.LinearLayout/android.widget.Button[2]");
            okButton.Click();

            var startTimeField = driver.FindElementById("editTextStartTime");
            startTimeField.Click();
            okButton = driver.FindElementByXPath("//android.widget.ScrollView/android.widget.LinearLayout/android.widget.Button[2]");
            okButton.Click();
