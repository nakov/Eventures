...
namespace Eventures.WebApp.Models
{
    ...
    public class EventCreateBindingModel
    {
        ...
        [Range(0, MaxEventTickets, ErrorMessage = "Total Tickets must be a positive number and less than {2}.")]
        public int TotalTickets { get; set; }

        [Required]
        [Display(Name = "PricePerTicket")]
        [Range(0.00, MaxEventPrice, ErrorMessage = "Price Per Ticket must be a positive number and less than {2}.")]
